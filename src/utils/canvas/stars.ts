import app from "@/utils/canvas";
import { Graphics, Texture, Sprite } from "pixi.js";

// @ts-ignore: Could not find definition for parameter 'addChild'. 在stage中添加
...
//创建纹理
const starTexture = Texture.from("./src/assets/img/star.png");
